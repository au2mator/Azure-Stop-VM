...
# Code Template V 1.5
#
# URL: https://au2mator.com/documentation/use-powershell-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=AZURE_StopVM&utm_content=PS1
...
## Environment
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\AZURE - Stop a VM\LOGS"
[string]$LogfileName = "AZURE - Stop a VM"
[string]$CredentialStorePath = "C:\_SCOworkingDir\TFS\PS-Services\CredentialStore" #see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_StopVM&utm_content=PS1
...
###TeamsCredentials to send Teams Card #https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_StopVM&utm_content=PS1
...
###Stored Credentials
###See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_StopVM&utm_content=PS1
...
try {
    ...
    try {
        Write-au2matorLog -Type INFO -Text "TRY to stop VM"
        ...
        foreach ($s in $Subs.value) {
            ...
            if ($VMfromSub.value.id.Length -gt 1) {
                ...
                #Script
                $URL_Action = "https://management.azure.com$($VMfromSub.value.id)/deallocate?api-version=2022-08-01"
                ...
                do {
                    ...
                    if ($Count -gt 10) {
                        throw   "Timeout Reached to stop VM"
                    }
